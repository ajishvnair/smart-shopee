        ...
        <View style={styles.infoRecipeContainer}>
            ...
            <View>
              ...
              <View style={styles.infoContainerSub}>
                <Text style={styles.discountPrice}>
                  ₹ 150<Text style={styles.actualPrice}> ₹ 100</Text>
                </Text>
          ...
          <View style={styles.validity}>
            ...
            <View style={styles.addQuantity}>
              <Text style={{ ...styles.quantityText, color: "#C0C0C0" }}>
                -
              </Text>
              <Text style={{ ...styles.quantityText, color: "#2cd18a" }}>
                1
              </Text>
              <Text style={{ ...styles.quantityText, color: "#2cd18a" }}>
                +
          ...
          <View style={styles.delivery}>
            ...
            <View style={styles.location}>
              ...
              />
              <Text style={styles.address}>Pulimudu, Parathodu, 686512 </Text>
            </View>
